...
import '../ui/vendor/analytics/vendor_analytics_page.dart';
import '../ui/vendor/dashboard/vendor_dashboard_page.dart';
import '../ui/vendor/menu/create_menu_item_page.dart';
import '../ui/vendor/menu/vendor_menu_page.dart';
import '../ui/vendor/orders/vendor_order_details_page.dart';
import '../ui/vendor/orders/vendor_orders_page.dart';
import '../ui/vendor/restaurant/create_restaurant_page.dart';
import '../ui/vendor/restaurant/restaurant_pending_page.dart';
import '../ui/vendor/settings/vendor_settings_page.dart';
import '../ui/vendor/tables/table_management_page.dart';
...
class AppRouter {
  ...
  static MaterialPageRoute<dynamic> genrateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case RouteName.vendorSplash:
        return MaterialPageRoute(
          builder: (_) => const SplashScreen(entryPoint: 'vendor'),
        );
      ...
      case RouteName.offerDetails:
        final args = settings.arguments as Map<String, dynamic>? ?? {};
        return MaterialPageRoute(
          builder: (_) => OfferDetailsPage(offer: args),
        );

      // Settings
      case RouteName.cardStyleSettings:
        return MaterialPageRoute(
          builder: (_) => FoodCardStyleSettingsPage(),
        );
      ...
      // ============= Vendor Routes =============
      case RouteName.vendorDashboard:
        return MaterialPageRoute(builder: (_) => const VendorDashboardPage());
      case RouteName.createRestaurant:
        return MaterialPageRoute(
          builder: (_) => BlocProvider(
            create: (_) =>
                getIt<VendorRestaurantBloc>()..add(LoadMyRestaurants()),
            child: const CreateRestaurantPage(),
          ),
        );
      case RouteName.restaurantPending:
        return MaterialPageRoute(
          builder: (_) => BlocProvider(
            create: (_) =>
                getIt<VendorRestaurantBloc>()..add(LoadMyRestaurants()),
            child: const RestaurantPendingPage(),
          ),
        );
      case RouteName.vendorMenu:
        return MaterialPageRoute(builder: (_) => const VendorMenuPage());
      case RouteName.createMenuItem:
        return MaterialPageRoute(builder: (_) => const CreateMenuItemPage());
      case RouteName.editMenuItem:
        final item = settings.arguments as FoodItem?;
        return MaterialPageRoute(
          builder: (_) => CreateMenuItemPage(existingItem: item),
        );
      case RouteName.vendorOrders:
        return MaterialPageRoute(builder: (_) => const VendorOrdersPage());
      case RouteName.vendorOrderDetails:
        final orderId = settings.arguments as String;
        return MaterialPageRoute(
          builder: (_) => VendorOrderDetailsPage(orderId: orderId),
        );
      case RouteName.vendorSettings:
        return MaterialPageRoute(builder: (_) => const VendorSettingsPage());
      case RouteName.vendorAnalytics:
        return MaterialPageRoute(builder: (_) => const VendorAnalyticsPage());
      case RouteName.tableManagement:
        return MaterialPageRoute(builder: (_) => const TableManagementPage());

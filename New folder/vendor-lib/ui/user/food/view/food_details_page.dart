...
class OneFoodDetailsPage extends StatelessWidget {
  final String foodId;

  const OneFoodDetailsPage({super.key, required this.foodId});

  @override
  Widget build(BuildContext context) {
    log('Navigated to Food Details Page with foodId: $foodId');
    return BlocProvider(
      create: (context) =>
            ...
            slivers: [
              ...
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  background: OneImageWidget(food: food),
                ),
                leading: Padding(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      ...
                      colors.scaffoldBackground.withValues(alpha: 0.9),

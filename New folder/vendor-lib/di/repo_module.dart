...
void registerRepositories(GetIt sl) {
  ...
  sl.registerLazySingleton<VendorRestaurantRepo>(() => VendorRestaurantRepo());
  sl.registerLazySingleton<VendorOrderRepo>(() => VendorOrderRepo());
  sl.registerLazySingleton<VendorAnalyticsRepo>(() => VendorAnalyticsRepo());
  sl.registerLazySingleton<VendorMenuRepo>(() => VendorMenuRepo());
}

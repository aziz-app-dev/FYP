import 'package:bloc_template/bloc/movies_bloc/movies_bloc.dart';
import 'package:bloc_template/data/response/response.dart';
import 'package:bloc_template/data/response/status.dart';

...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    // Load the vendor's restaurant so Food CRUD knows which restaurant
    // to operate on.
    Get.put(VendorRestaurantController()).fetchMine();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        toolbarHeight: 80.spMin,
        // SafeArea keeps our custom header below the system status bar
        // instead of bleeding behind it.

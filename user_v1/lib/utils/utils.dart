...
class Utils {
  ...
  /// GetX-based toast: works from any controller/hook because the app
  /// runs inside a GetMaterialApp (no extra plugin needed).
  static void _toast(String title, String message, Color bg) {
    Get.snackbar(
      title,
      message,
  ...
  static void showCustomSnackbar({
    ...
    _toast(title, message, backgroundColor ?? kPrimary);
  }
}

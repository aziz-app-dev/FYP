  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: Obx(() => AbsorbPointer(
            absorbing: cartController.isLoading,
            child: ListView(
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // ! order place + add to cart (with animated fill on loading)
              Obx(() {
                final isAdding = cartController.isLoading;
                ...
                return ClipRRect(
                  ...
                  child: Stack(children: [
                    ...
                    // animated fill layer (sweeps left → right)
                    TweenAnimationBuilder<double>(
                      tween: Tween<double>(
                          begin: 0, end: isAdding ? 1.0 : 0.0),

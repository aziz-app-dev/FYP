...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    // Do NOT call fetchCartCount / fetchUserData here — they set observable
    // loading state synchronously, which triggers the parent Obx to rebuild
    // during build and throws. They're already triggered in initState.
